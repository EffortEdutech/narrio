# Sprint 2.5 — GitHub Issues Backlog

Use this file to manually create GitHub issues after local testing.

## Issue 2.5.1 — Productize Narrio brand language

**Labels:** `sprint-2.5`, `branding`, `product-language`
...
## Issue 2.5.2 — Add shared brand config package

**Labels:** `sprint-2.5`, `config`, `frontend`
...
## Issue 2.5.3 — Replace marketing placeholder with Narrio landing copy

**Labels:** `sprint-2.5`, `marketing`, `ui-copy`
...
## Issue 2.5.4 — Polish web homepage and Writer Studio language

**Labels:** `sprint-2.5`, `web`, `ui-copy`
...
## Issue 2.5.5 — Update editor language for ForkCraft timelines

**Labels:** `sprint-2.5`, `editor`, `forkcraft`
